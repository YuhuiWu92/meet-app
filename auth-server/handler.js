...
const credentials = {
  ...
  redirect_uris: ["https://yuhuiwu92.github.io/meet-app/"],
  javascript_origins: ["https://yuhuiwu92.github.io", "http://localhost:3000"],
};
...
module.exports.getAccessToken = async (event) => {
  ...
  /*  ${event.pathParameters.code} means:
  in serverless.yml=>functiongetAccessToken 
  getAccessToken:
